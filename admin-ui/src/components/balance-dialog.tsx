          ...
          <div className="space-y-4">
            ...
            {(() => {
              ...
              <div className="space-y-2">
                ...
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  {overage && <span className="text-red-500 ml-1">(超额 ${formatNumber(balance.currentUsage - balance.usageLimit)})</span>}
                </div>
              </div>
              )
            })()}
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t text-sm">
              <div>
                ...
                <span className={`font-medium ${balance.remaining > 0 ? 'text-green-600' : 'text-red-500'}`}>
