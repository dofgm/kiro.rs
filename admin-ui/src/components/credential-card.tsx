      ...
      <Card className={credential.isCurrent ? 'ring-2 ring-primary' : ''}>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span className="text-muted-foreground">累计 Credits：</span>
              <span className="font-medium">{credential.totalCredits.toFixed(4)}</span>
            </div>
            <div>
              <span className="text-muted-foreground">上次消耗：</span>
              <span className="font-medium">{credential.lastRequestCredits.toFixed(4)}</span>
            </div>
