        ...
        let start_events = self.state_manager.handle_content_block_start(
            ...
            json!({
                ...
                "content_block": {
                    ...
                    "name": self.tool_name_map.get(&tool_use.name).cloned().unwrap_or_else(|| tool_use.name.clone()),
                    "input": {}
                }
            }),
        );
...
impl BufferedStreamContext {
    ...
    pub fn new(
        ...
        let inner =
            StreamContext::new_with_thinking(model, estimated_input_tokens, thinking_enabled, true, tool_name_map);
        Self {
            inner,
